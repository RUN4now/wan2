...
export function Hero() {
  ...
  return (
    <section id="home" className="relative pt-24 pb-24 md:pt-32 md:pb-32 overflow-hidden w-full" style={{ background: 'var(--bg)' }}>
      ...
      <div className="relative z-10 w-full pointer-events-none h-full flex flex-col">
        <div className="flex items-start justify-between w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex-1 flex items-end justify-end pb-8 pr-4 md:pr-8 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
